                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <p style="font-size:14px;font-family:Arial;padding:0px 15px;line-height:22px">
                                                        ...
                                                        <b style="font-size:16px;"> Survey Title  :</b>

                                                           {{ isset($survey->heading) ? $survey->heading :''}}.
                                                        
<br>
                                                       <b style="font-size:16px;"> Survey Description  :</b>

                                                         {{ isset($survey->description) ? $survey->description :''}}.
                                                        
@php  $link="https://binarymetrix-dev.com/loyola/admin/survey/".str_slug($survey->heading);  @endphp
 <p                                  
                                                        ...
                                                        Link : <a href="{{ $link }}"
                                                            ...
                                                            style="color:#282525;" target="_blank">Click here</a></p>
                                                ...
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        face any issues, please reach out to <a
                                                            ...
                                                            style="color:#282525;" target="_blank">loyola@gmail.com</a>

                                                        or call on +44 474746666 </p>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:0px 0px 10px 35px">
                                                    ...
                                                    <p
                                                        ...
                                                        <strong style="color:#66CBFE">Support 
