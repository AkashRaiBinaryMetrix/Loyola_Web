		...
		<div class="col-md-8 custom-8col">
		  ...
		  <strong>Success!</strong> Community joined successfully.
			...
			<div class="communities-wrapper">
			  <div class="title-col"><h2 class="title">Discover SubCategory</h2>
			  <div class="search-inner">
				
					<div class="form-group">
					<form class="main-search-form" name="cform" method="post" action="{{route('search.subcategory')}}">
					@csrf
					<div class="form-group">
						<input type="hidden" class="form-control" name="continent" value="{{$continent}}">
			    ...
			    <div class="community-columns" id="other-community">
				  ...
				  <div class="row">
					...
					<div class="col-md-4 col-xl-3 col-6">
					  <div class="community-col"><a href="{{route('user.subcommunity.all',[$cat->continent,$cat->catslug,$cat->slug])}}">
						<div class="community-fig"><img src="{{asset('public/subcat/'.$cat->image)}}" alt=""></div>
