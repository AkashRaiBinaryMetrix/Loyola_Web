...
<div class="regions-sec">
  ...
  <div class="container">
	    ...
	    <div class="regions-col">
		  ...
		  <a href="{{url($cat->name)}}"><img src="{{asset('public/category/'.$cat->image)}}" alt=""><span class="{{$text}}-text">{{$cat->name}}</span></a>  
			  ...
			  @endif
		        ...
		        $urllink=url('/').'/'.$community.'/comments/'.$randnum.'/'.$post->slug;
				 ...
				 <ul class="dropdown-menu">
				  ...
				  <li><a href="http://www.facebook.com/sharer.php?s=100&p[url]={{$urllink}}&p[images][0]={{$img}}&p[title]={{$titleweb}}&p[summary]='If I Were'" target="_blank" target="_blank"><i class="fa fa-facebook-f" style="padding-right: 5px;"></i>Share on Facebook</a></li> 

				  <li><a href="https://twitter.com/share?url={{$urllink}}&text=IF I WERE...MAKING THE WORLD A BETTER PLACE check this post" target="_blank"><i class="fa fa-twitter" style="padding-right: 5px;"></i>Share on Twitter</a></li>

				  <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{$urllink}}&title=$post->slug&summary=IF I WERE...MAKING THE WORLD A BETTER PLACE check this post&source=IF I WERE...MAKING THE WORLD A BETTER PLACE"><i class="fa fa-linkedin" style="padding-right: 5px;"></i>Share on Linkedin</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form">
        	...
        	<label data-error="wrong" data-success="right" for="form32">What do you want us to add?</label>
		...
		<div class="md-form">
			<label class="radio-inline">
      			<input type="radio" name="optradio" value="category" style="margin: -3px 7px 2px -1px;" onchange="checkRadioValue('category');">Category
    		</label>
    
			<label class="radio-inline">
      			<input type="radio" name="optradio" value="subcategory" style="margin: 0px 7px 0px 7px;" onchange="checkRadioValue('subcategory');">Sub-Category
    		</label>
		</div>
		...
		<div class="md-form">
			...
			<div id="category_div" style="display:none;">
				<label data-error="wrong" data-success="right" for="form8">Select Continent</label>
				<select class="form-control" name="category_continent" id="category_continent" required="">
						<option value="">Select Continent</option>
						@foreach ($continent as $continentsListResult)
							<option value="{{$continentsListResult->name}}">{{$continentsListResult->name}}</option>
						@endforeach
				</select>
				<div class="clearfix"></div>
				<label data-error="wrong" data-success="right" for="form8" style="margin-top: 8px;">Enter Category Name</label>
				<input type="text" class="form-control" name="category_category" id="category_category" placeholder="Category Name" required="" style="margin-bottom: 12px;">
				<label data-error="wrong" data-success="right" for="form8" style="margin-top: 8px;">Enter Sub-Category Name</label>
				<input type="text" class="form-control" name="subcategory_name_1" id="subcategory_name_1" placeholder="Sub-Category Name" required="" style="margin-bottom: 12px;">
			</div>
			<!--Category div-->
			...
			<div id="subcategory_div" style="display:none;">
				<label data-error="wrong" data-success="right" for="form8">Select Continent</label>
				<select class="form-control" name="subcategory_continent" id="subcategory_continent" required="" onchange="displayCategoryContact();">
						<option value="">Select Continent</option>
						@foreach ($continent as $continentsListResult)
							<option value="{{$continentsListResult->name}}">{{$continentsListResult->name}}</option>
						@endforeach
				...
				<div class="clearfix"></div>
				<div id="subcategory_div_1"></div>
				<div class="clearfix"></div>
				<label data-error="wrong" data-success="right" for="form8" style="margin-top: 8px;">Enter Sub-Category Name</label>
				<input type="text" class="form-control" name="subcategory_name" id="subcategory_name" placeholder="Sub-Category Name" required="" style="margin-bottom: 12px;">
			</div>		
			<!--Subcategory Div-->
		</div>
      ...
      <div class="modal-footer d-flex justify-content-center">
		<input type="hidden" id="set_radio_valio" name="set_radio_valio"/>
