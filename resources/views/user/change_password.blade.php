...
<div class="main-wrapper">
   <div class="container">
	   ...
	   <form method="post" action="{{route('user.change.password',$email)}}" id="changepassform">
	   	@csrf
		...
		<div class="inner-createnow">
		  <div class="top-innercreate">
			 <div class="row">
			  	<div class="col-md-3 col-sm-6">
				   <div class="form-group createpost-field">
					...
					<input type="password" class="form-control" name="oldpassword" id="oldpass" placeholder="" >
					<span id="oldpasserrc"></span>
				  </div>
				 </div>
			...
			<div class="form-group mb-1 mt-4 submit-col text-md-right">
			  <button type="submit" class="common-btn" id="changepbtn">Submit</button>
			</div>
